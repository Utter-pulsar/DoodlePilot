...
/**
 * An Apple-style on/off switch in the hand-drawn look: a sketchy pill track (wobbled by
 * the #doodle-wobble filter via `doodle-edge`) with a thumb that springs left↔right.
 * Fills marker-green when on, neutral when off — matching DoodleCheckbox's palette.
 */
